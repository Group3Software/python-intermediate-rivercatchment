...
def test_create_site_with_position():
    ...
    name = 'PL23'
    longitude = 5  # This is a made up location for the unit test only; no actual data is accessed
    latitude = 7
    position = gpd.GeoDataFrame(geometry=[Point((longitude, latitude))], crs='EPSG:4326')  # Test that this line
    p = Site(name=name, longitude=longitude, latitude=latitude)  # corresponds to this line
